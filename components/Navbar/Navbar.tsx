    ...
    >
      <div className="container">
        <div className="flex justify-between items-center">
          ...
          <div>
            <img
              src={setting.darkLogo}
              alt=""
              className="w-16 sm:w-24 dark:block absolute top-0 left-0 sm:left-1/2 sm:-translate-x-1/2 m-2 sm:m-0 "
            />
            <img
              src={setting.darkLogo}
              alt=""
              className="w-16 sm:w-24 dark:hidden absolute top-0 left-0 sm:left-1/2 sm:-translate-x-1/2 m-2 sm:m-0 "
            />
          </div>
